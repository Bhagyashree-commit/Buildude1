...
import com.example.labourmangement.Contractor.AllJobs;
...
public class ArchitechProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("ARCHITECT PROFILE");
...
//        loader.show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.viewjob:
                Intent i3=new Intent(ArchitechProfile.this, AllJobs.class);
                startActivity(i3);
                break;
